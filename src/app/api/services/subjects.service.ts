...
class SubjectsService extends __BaseService {
  static readonly registerStudentsPath = '/subjects/add';
  static readonly listGradesPath = '/subjects/list';
   ...
   * @param params The `SubjectsService.ListGradesParams` containing the following parameters:
   *
   * - `startPosition`:
   *
   * - `maxResult`:
   ...
   * @return successful operation
   */
  listGradesResponse(params: SubjectsService.ListGradesParams): __Observable<__StrictHttpResponse<Array<DefaultListResponseDTO>>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @return successful operation
   */
  listGrades(params: SubjectsService.ListGradesParams): __Observable<Array<DefaultListResponseDTO>> {
